...
class Configuration():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataset_mode', type=str, default='aligned', help='aligned,single,custom')
        #parser.add_argument('--dataset_mode', type=str, default='custom', help='aligned,single,custom')
